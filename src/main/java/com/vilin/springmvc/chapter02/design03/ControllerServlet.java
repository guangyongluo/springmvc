...
import com.vilin.springmvc.chapter02.design01_02.SaveProductAction;
...
public class ControllerServlet extends HttpServlet {
    ...
    private void process(HttpServletRequest request, HttpServletResponse response)
        ...
        if ("input-product".equals(action)) {
            ...
            dispatchUrl = "/jsp/chapter03/design03/ProductForm.jsp";
            ...
            if (errors.isEmpty()) {
                ...
                dispatchUrl = "/jsp/chapter03/design03/ProductDetails.jsp";
            } else {
